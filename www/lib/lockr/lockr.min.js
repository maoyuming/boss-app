!function (root, factory) {
    ...
    return Array.prototype.indexOf || (Array.prototype.indexOf = function (elt) {
        ...
        try {
            values.push(value), json = JSON.stringify({data: values}), localStorage.setItem(query_key, json)
        } catch (e) {
        ...
        index = values.indexOf(value), index > -1 && values.splice(index, 1), json = JSON.stringify({data: values});
        try {
